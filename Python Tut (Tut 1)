Welcome.
Welcome Luca.
This is a tutorial for Python and PyGame for Luca M. Roldan.
Made by: Luca O. Anthony

The tutorial will be inscribed in sections called "ATS."
The sections are called ATS as it is an acronym for Articulated Technical Sections.
Let's start.

ATS 1: Installments

A key thing to do in programming is to have an IDE, or, an Integrated Development Environment.
A IDE I use is Visual Studio Code, or, VS Code.
This is an IDE that can be used for coding in almost any language. C, C#, Python, Java, JavaScript, HTML, ETC.
...
Once it is running you will have to go to the extensions section on the sidebar
